# this script runs mashr on prepped eQTL results to find response eQTLs
# based on mashr vignette https://stephenslab.github.io/mashr/articles/intro_mash.html
# based on SCAIP-genetic/mashr_eQTL/mashr_compute_posterior_chunks.R
...
cat("Starting mashr for chunk", chunk, "\n")
